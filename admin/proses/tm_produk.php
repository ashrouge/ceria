...
$harga = $_POST['harga'];
$desk = $_POST['desk'];
$kategori = $_POST['kategori']; // Tambahkan baris ini untuk mengambil kategori
...
if (move_uploaded_file($tmp_file, "../../image/produk/".$namaGambarBaru)) {
	...
	// Tambahkan kategori ke dalam kueri SQL
	$result = mysqli_query($conn, "INSERT INTO produk VALUES('$kode','$nm_produk','$namaGambarBaru','$desk','$harga','$kategori')");
